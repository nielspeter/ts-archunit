...
| [0074](./0074-r3b-the-selector-glob-flip.md) — R3b: the selector glob flip                        | **DESIGNED, GATED.** Split out of [0069](./completed/0069-no-rule-may-certify-nothing.md) so a 90%-shipped plan stops waiting on a precondition that does not exist. Needs a real adopting codebase with a non-trivial finding population (the `doctor`/`diagnose()` split is settled by [0077](./completed/0077-doctor-promote-it.md); the loadable-file constraint is gone) — dogfooding was tried and refuted: 33 of 34 fixture projects produce zero findings. Breaking.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ~1 day once the gate opens | an adopting codebase + version sequencing |
