...
**Version:** 0.27.0 · **Tests:** 2508 across 178 files · **Updated:** 2026-07-30
...
| ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------- |
| [0071](./0071-one-definition-of-a-module-edge.md) — Forward dependency conditions see every module edge | **0.27.0 SHIPPED** — the three migration instruments are released (`--changed` discloses, `baseline` prints its delta, `docs/upgrading.md`). **0.28.0, the widening, is DRAFT 4 and remaining.** Draft 3's headline guard was green with bug 0022 fully restored — two reviewers found it independently; fixed in draft 4 | ~2 days  | nothing — closes bug 0022                                                                                |
