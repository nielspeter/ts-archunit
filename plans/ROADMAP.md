...
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------- |
| [0071](./0071-one-definition-of-a-module-edge.md) — Forward dependency conditions see every module edge | **DRAFT 4, implementation-ready.** Draft 3's headline guard was green with bug 0022 fully restored — two reviewers found it independently; fixed. Split in two: 0.27.0 ships migration instruments, 0.28.0 the widening — an adopter's pre-upgrade measurement must be trustworthy before the thing it measures changes | ~2 days  | nothing — closes bug 0022                                                                                |
