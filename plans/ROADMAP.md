...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------- |
| [0071](./0071-one-definition-of-a-module-edge.md) — One definition of a module edge | **READY** — designed from a three-persona review; both bugs' suggested fixes withdrawn on measurement | ~2 days  | nothing — closes bugs 0022 and 0015                                                                               |
...
| [0015](../bugs/0015-allowlist-conditions-pass-vacuously-on-edgeless-subjects.md) — `only*` conditions pass on ∅                                       | **Open — designed, see [plan 0071](./0071-one-definition-of-a-module-edge.md).** Its suggested fix is **withdrawn**: for the `only*` family zero edges is maximal compliance, and a per-subject failure has no statable remedy (measured: `tarjan.ts` and 9 other pure leaf modules). The unit is the **rule**, in three tiers. Cannot ship before 0022 — 6 files here have 0 static imports and real edges, incl. `src/index.ts` with 114.                                                                                                                                        |
