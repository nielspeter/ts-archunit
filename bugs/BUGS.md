...
**Version:** 0.42.0 · **Open:** 2 · **Fixed:** 47 (`fixed/`) · **Updated:** 2026-08-01
...
| --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1                                                                                                                           | [0048](./0048-the-dead-glob-gate-blames-the-glob-when-the-project-is-empty.md) — the dead-glob gate blames the glob when the project is empty | High                                                                                                                                                                                                                                                                                                                                                                                                                | A **confidently wrong remedy** on a shipped path: told to correct a glob that is correct. `diagnose()` has the bug-0031 short-circuit; the gate does not. It also escapes the character-for-character parity the suite believes it pins, so that test reports coverage it lacks. First because [plan 0080](../plans/0080-admit-discovery-globs-to-the-dead-glob-gate.md) widens this gate to three more builders. |
| 2                                                                                                                           | [0048](./0048-the-dead-glob-gate-blames-the-glob-when-the-project-is-empty.md) — the dead-glob gate blames the glob when the project is empty | **OPEN, high.** Measured on `tests/fixtures/does-not-load`: the gate says _"Correct the glob, or remove the rule"_ while `doctor` says _"the project loaded 0 source files"_. Bug 0031 fixed this on `diagnose()` only; the gate grew the same reasoning independently and nothing compares the two on this input. Fix by extracting the short-circuit rather than copying it — a second copy is how this happened. |
